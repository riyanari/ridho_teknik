...
class _ServisItemAcDetailPageState extends State<ServisItemAcDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Ambil data diagnosa dan tindakan dari item
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      'Teknisi tidak mememiliki diagnosa terhadap AC',
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.grey[500],
                      ),
  ...
  Widget _buildTindakanSection(List<String> tindakanList) {
    // Konversi string tindakan ke format display yang lebih rapi
    final displayTindakan = tindakanList.map((t) {
      switch (t.toLowerCase()) {
        case 'pembersihan':
          return 'Pembersihan AC';
        case 'isi_freon':
          return 'Isi Freon';
        case 'ganti_filter':
          return 'Ganti Filter';
        case 'perbaikan_kompressor':
          return 'Perbaikan Kompressor';
        case 'perbaikan_pcb':
          return 'Perbaikan PCB';
        case 'ganti_kapasitor':
          return 'Ganti Kapasitor';
        case 'ganti_fan_motor':
        ...
        case 'lainnya':
          return 'Lainnya';
        default:
        // Format string: replace underscore with space and capitalize
          final formatted = t
              .replaceAll('_', ' ')
              .split(' ')
            ...
            children: [
              ...
              Expanded(
                child: _buildSpecItem(
                  icon: Icons.speed,
                  label: 'Kapasitas',
                  value: capacity.isNotEmpty ? capacity : '-',
                ),
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _getCategoryColor(title).withValues(alpha:0.1),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                  '${photos.length}',
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Foto dokumentasi untuk AC ini belum tersedia',
            style: TextStyle(
              fontSize: 14,
              color: Colors.grey[500],
            ),
